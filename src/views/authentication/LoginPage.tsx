    ...
    return (
        <>
            ...
            <div className="flex justify-around">
                <div className="xl:flex-1 xl:h-auto md:h-[550px] h-[350px] w-[450px]">
                    <EarthCanvas />
                </div>
                <div className="flex min-h-full min-w-[500px] flex-col justify-center py-2 sm:px-6 lg:px-8 mt-8">
